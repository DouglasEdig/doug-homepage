...
import iconPirate from "../../assets/lufy.svg";
...
export default function NavBar() {
  return (
    <Disclosure as="nav" className=" bg-bgColor fixed top-0 w-full z-50">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-center gap-10">
                <div className="flex flex-shrink-0 items-center justify-center cursor-pointer">
                  <p className=" text-black flex rounded-md px-3 py-2 font-semibold text-xl">
                    <img src={iconPirate.src} alt="pirate" />
                    Douglas Silva
                  </p>
                </div>
